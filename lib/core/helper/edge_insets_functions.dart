...
class REdgeInsets {
  ...
  static EdgeInsets only({double bottom = 0, double top = 0, double right = 0, double left = 0}) {
    return EdgeInsets.only(bottom: bottom.h, top: top.h, right: right.w, left: left.w);
  }
}
